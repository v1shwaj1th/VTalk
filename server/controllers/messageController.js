...
// when user logs in he sees all other users excecpt him in chat section
export const getUsersForSidebar = async (req, res) => {
  try {
    ...
    res.json({ sucess: true, users: filterUsers, unseenMessages });
  } catch (error) {
...
export const sendMessages = async (req, res) => {
  try {
    ...
    // if we have img, upload on cloudinary
    let imageUrl;
    if (image) {
